...
std::size_t Intel8080::executeInstruction() {
    ...
    switch (instruction) {
        ...
        case 0xa8: xra(register_B); break; // XOR B
        case 0xa9: xra(register_C); break; // XOR C
        case 0xaa: xra(register_D); break; // XOR D
        case 0xab: xra(register_E); break; // XOR E
        case 0xac: xra(register_H); break; // XOR H
        case 0xad: xra(register_L); break; // XOR L
        case 0xae: xra(memory[register_HL]); break;    // XOR M
        case 0xaf: xra(register_A); break; // XOR A

        case 0xb0: ora(register_B); break; // OR B
        case 0xb1: ora(register_C); break; // OR C
        case 0xb2: ora(register_D); break; // OR D
        case 0xb3: ora(register_E); break; // OR E
        case 0xb4: ora(register_H); break; // OR H        
        case 0xb5: ora(register_L); break; // OR L
        case 0xb6: ora(memory[register_HL]); break;    // OR M
        case 0xb7: ora(register_A); break; // OR A
        ...
        case 0xdb: register_A = in_callback(nextByte()); break;
